...
func CalltoStoreServerFile() string {
	...
	for o := range File {
		...
		Templated2 += fmt.Sprintf(`<div class="codeheader" id="JSON">JSON FILE (DB) | %s </div>`, Files[o])
